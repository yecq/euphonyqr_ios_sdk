...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.buyfullSDK = [[BuyfullSDK alloc]initWithAppkey:@"75ba120532f44aa7a8cd431a2c2a50ef" isSandbox:TRUE tokenURL:@"https://sandbox.euphonyqr.com/testycq2/buyfulltoken"];
